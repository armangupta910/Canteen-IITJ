...
class admin_available : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_admin_available)
        ...
        db.collection("avail").document("avail").get().addOnSuccessListener {
            ...
            val x=findViewById<RecyclerView>(R.id.recycler_for_available)
            val y=adaptor_for_available_and_not_available(this,demo,data,"0")
