...
class third : Fragment() {
    ...
    override fun onCreateView(
        ...
        val demo=inflater.inflate(R.layout.fragment_third, container, false)
        ...
        db.collection("Menu_Items").get().addOnSuccessListener {
            for(i in it){
                if (i.data.get("Category")=="3"){
                    list.add(i.id)
                }
            }

            val x=demo.findViewById<RecyclerView>(R.id.recycler_fragment3)
            ...
            x.adapter=y
            demo.findViewById<SwipeRefreshLayout>(R.id.swipe3).setOnRefreshListener {
                ...
                db.collection("Menu_Items").get().addOnSuccessListener {
                    ...
                    Handler().postDelayed({
                        demo.findViewById<SwipeRefreshLayout>(R.id.swipe3).isRefreshing = false
                    }, 1200)
                }
            }
        }
        ...
        search10 = demo.findViewById<SearchView>(R.id.search_view3) as SearchView
